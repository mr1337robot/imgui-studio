...
- `phase2-build.integration.ts` uses the real pinned Emscripten toolchain to verify initial promotion,
  ...
  It then verifies Phase 4 preview load, reset, stored inspection, stable targeting, canonical
  capture, reference comparison, and three clean normalized trace digests against that exact build.
